...
![img.png](assets/uml2.png)

## 3.Исходный код системы или ссылка на репозиторий с исходным кодом.

https://github.com/listoCheck/IS-labs/tree/lab2

## 4.Выводы по работе.

В данной лабораторной работе я сделал систему импорта объектов, при помощи файла формата json.
Так же я поменял фронтенд для более удобного юзер экспириенса. На беке соответственно добавил контроллер и сервис для обработки этих файлов.
Потом я сделал нагрузочное тестирование при помощи Apache Jmeter.